...
const YouTubePlayer = forwardRef(function YouTubePlayer(
  ...
  ref  // ← cette ref viendra de App.js
) {
  ...
  if (isYouTube) {
    ...
    return (
      <div
        ref={ref}                                                                             
        style={{ position: 'relative', maxWidth: '1000px', maxHeight: '500px' }}
      >
        <YouTube
          videoId={videoId}
          opts={{
          ...
          iframeClassName="youtube-iframe"  // on ajoutera l'allowFullscreen via CSS/JS si besoin
        />
      </div>
    );
  }
